...
{
    public class KlientViewModel : AItemListViewModel<KlientForView>
    {
        ...
        public KlientViewModel() : base("Klient") { }
        ...
        {
            await Shell.Current.GoToAsync($"{nameof(KlientDetailPage)}?{nameof(KlientDetailViewModel.ItemId)}={item.KlientId}");
        }
